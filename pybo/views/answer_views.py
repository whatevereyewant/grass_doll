...
def detail(request, question_id):
    ...
    # 각 답변에 대한 감정 분석 결과를 계산하고 결과를 전달
    emotion_results = []
    for answer in answers:
        emotion_result = perform_emotion_analysis(answer.content)
        emotion_results.append({'answer_id': answer.id, 'emotion': emotion_result})
    
    context = {'question': question, 'answers': answers, 'emotion_results': emotion_results}
    return render(request, 'pybo/question_detail.html', context)
